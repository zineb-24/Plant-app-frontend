...
class AddUserPlantFormState extends State<AddUserPlantForm> {
  ...
  Future<void> _addPlant() async {
    ...
    try {
      ...
      if (response.statusCode == 201) {
        final userPlant = json.decode(response.body);
        ...
        for (var task in tasksToAdd) {
          await http.post(
            Uri.parse('http://10.0.2.2:8000/api/plants/${userPlant['id']}/add-tasks/'),
            headers: {
              'Authorization': 'Basic $credentials',
              'Content-Type': 'application/json',
            },
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            if (selectedImage != null || widget.plantSpecies['image'] != null)
              ListTile(
                leading: Container(
                  padding: const EdgeInsets.all(8),
                  decoration: BoxDecoration(
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Add a ${widget.plantSpecies['species_name']}',
                      style: const TextStyle(
                        fontSize: 24,
                        fontWeight: FontWeight.bold,
                        color: Colors.black,
          ...
          child: Column(
            ...
            children: [
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      image: selectedImage != null
                                          ...
                                          : widget.plantSpecies['image'] != null
                                              ? DecorationImage(
                                                  image: NetworkImage(widget.plantSpecies['image']),
                                                  fit: BoxFit.cover,
                                                )
                                              : null,
                                    ),
                                    child: selectedImage == null && widget.plantSpecies['image'] == null
                                        ? Container(
                                            decoration: BoxDecoration(
                                              color: Colors.grey[100],
                                              borderRadius: BorderRadius.circular(20),
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    widget.plantSpecies['species_name'],
                                    style: TextStyle(
                                      fontSize: 18,
                                  ...
                                  Text(
                                    widget.plantSpecies['scientific_name'],
                                    style: TextStyle(
                                      fontSize: 16,
                                      color: Color(0xFF4E4E4E),
              ...
              SizedBox(
                ...
                child: TextButton(
                  onPressed: isLoading ? null : _addPlant,
